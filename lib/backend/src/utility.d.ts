...
export declare function runAppOnFreePort(app: any, port: number, ctrl: boolean): Promise<{}>;
...
export declare function getHtmlOrTsFile(items: {
    path: '';
}[]): "";
export declare function getAngular5Projects(config: any): string[];
export declare function logDanger(message: string): void;
export declare function logInfo(message: string): void;
export declare function logServerBusyError(): void;

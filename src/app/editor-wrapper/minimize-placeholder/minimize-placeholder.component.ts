  ...
  template: `
    <div 
      ...
      <div *ngIf="isLoading"
        ...
        <svg class="lds-spinner" width="24px"  height="24px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><g transform="rotate(0 50 50)">

...
export class ImageByExtensionPipe implements PipeTransform {
  ...
  transform(fileName: string, args?: any): any {
    ...
    if(fileName.endsWith('.json')) return 'https://upload.wikimedia.org/wikipedia/commons/c/c9/JSON_vector_logo.svg';
    else return 'https://us.123rf.com/450wm/urfandadashov/urfandadashov1808/urfandadashov180817062/107901402-stock-vector-file-vector-icon-isolated-on-transparent-background-file-logo-concept.jpg?ver=6';
  }
